...
<body>
    <header>
        <nav class="navegation">
            <a href="index.php" class="logo">F<span>riendly</span> C<span>linic</span></a>
            <ul class="nav-menu">
                <li class="nav-item" id="home"><a href="index.php">Home</a></li>
                <li class="nav-item"><a href="#">Calendário</a></li>
                <li class="nav-item"><a href="#">Contato</a></li>
                <li class="nav-item"><a href="assets/PHP/qmsomos.php">Quem Somos</a></li>
            ...
            <div class="perfil-dropdown">
                ...
                <ul class="perfil-dropdown-list">
                    <li class="dropdown-item"><a href="assets/PHP/login.php">Sing-in</a></li>
                    <li class="dropdown-item"><a href="assets/PHP/cadastro.php">Sing-up</a></li>
                </ul>
            </div>
    ...
    <section class="section-inicio-homepage">
        <div class="container">
            ...
            <div class="right-side">
                <img src="assets/IMGs/GATO.jpg" alt="Image not found">
            </div>
        </div>
    </section>
    <section class="section-calendario">
        <div class="left-side-calendario">
            <img src="assets/IMGs/TIGRINHO.jpeg" alt="Image not found">
        </div>
    ...
    <section class="section-gerenciar">
        <div class="left-side-gerenciar">
            <img src="assets/IMGs/Imagem-paw.jpg" alt="Image not found">
        </div>
    ...
    <footer>
        <h1><a href="index.php" class="logoFooter">F<span>riendly</span> C<span>linic</span></a></h1>
